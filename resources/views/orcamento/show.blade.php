    ...
    <div class="card m-3">
        <div class="card-header justify-content-between">
            ...
            <div class="d-flex justify-content-between col-auto">
                ...
                <a href="{{ route('orcamento.site.import', ['orcamento' => $orcamento]) }}" class="btn btn-success w-100 mb-1 me-2">
                    ...
                    <div class="accordion-item m-3 mb-0">
                        <div class="accordion-header d-flex justify-content-between align-items-center">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-{{ $site->id }}-tabs" aria-expanded="false">
                                {{ $site->Site->nome }} {{ !empty($site->Site->id_instalacao) ? "| ".$site->Site->id_instalacao : "" }} {{ !empty($site->Site->is_subestacao) ? "| Subestação" : "" }}
                            </button>
                            {{-- <div class="d-flex justify-content-between col-auto"> --}}
                                {{-- <div>
                        ...
                        <div id="collapse-{{ $site->id }}-tabs" class="accordion-collapse collapse" data-bs-parent="#accordion-tabs">
                            <div class="accordion-body pt-0">
                                ...
                                @if ($site->cotacoes->isNotEmpty())
                                    @include('orcamento.cotacoes', ['cotacoes' => $site->cotacoes])
                                @endif
                                        ...
                                        <div class="accordion accordion-tabs" id="accordion-{{ $ponta->id }}">
                                            <div class="accordion-item m-3">
                                                ...
                                                <div id="accordion-collapse-{{ $ponta->id }}" class="accordion-collapse collapse" data-bs-parent="#accordion-{{ $ponta->id }}">
                                                    ...
                                                    @if ($ponta->cotacoes->isNotEmpty())
                                                        @include('orcamento.cotacoes', ['cotacoes' => $ponta->cotacoes])
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
