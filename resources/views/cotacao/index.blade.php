    ...
    <div class="card m-3">
      ...
      <div class="table-responsive m-4">
        <table class="display w-100" id="tabela-cotacoes"> {{-- table card-table table-vcenter text-nowrap datatable --}}
          ...
          <tbody>
            @foreach ($sitesOrcamento as $siteO)
                    @foreach ($siteO->cotacoes as $cotacao)
                        @include('orcamento.modal.edit-status-orcamento', ['orcamento' => $siteO->Orcamento])
                        <tr>
                            <td>{{ $siteO->Orcamento->Cliente->nome }}</td>
                            <td>{{ $siteO->Site->nome }}</td>
                            <td>{{ $siteO->Site->endereco }}</td>
                            <td>{{ number_format($siteO->vel_solicitada_down, 0, ',', '.') }} Mbps</td>
                            <td>{{ $cotacao->SiteOrcamento->Orcamento->tempo_contrato }} meses</td>
                            @can('precificar orcamento')
                            ...
                            <td>{{ App\Models\Cotacao::getTecnologiaTexto($cotacao->tecnologia) }}</td>
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="#" class="btn-icon" data-bs-toggle="modal" data-bs-target="#modal-edit-status-orcamento">
                                        @if ($siteO->Orcamento->status == 'Sem viabilidade')
                                        ...
                                        @elseif ($siteO->Orcamento->status == 'Em cotação')
                                        ...
                                        @elseif ($siteO->Orcamento->status == 'Enviado')
                                        ...
                                        @elseif ($siteO->Orcamento->status == 'Aprovado')
                            ...
                            <td class="text-end">
                                <a class="btn justify-content-center" href="{{ route('orcamento.show', ['orcamento' => $siteO->Orcamento]) }}">
