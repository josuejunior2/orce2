            ...
            <div class="datagrid-item">
                ...
                <div class="datagrid-content">
                    @foreach($site->servicosSolicitados as $servico) 
                        <span class="badge badge-outline" title="{{ $servico->descricao }}" data-bs-toggle="tooltip" data-bs-placement="bottom" data-site="{{ $site->id }}" data-servico="{{ $servico->id }}" data-nome-servico="{{ $servico->nome }}" data-nome-site="{{ $site->nome }}" onmouseover="$(this).addClass('text-danger')" onmouseout="$(this).removeClass('text-danger')">{{$servico->nome}}</span> 
                    @endforeach
                </div>
            </div>
        </div>
